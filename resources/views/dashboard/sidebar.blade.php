<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
        <div class="mx-4 my-2 font-weight-bolder text-uppercase">Menu</div>
        <li class="nav-item {{ auth()->user()->role_id == 2 ? "d-none" : "" }}">
            <a class="nav-link {{ Route::current()->getName() == "dashboard.index" ? "active" : "" }}" href="{{ route('dashboard.index') }}">
                <div
                    ...
                    <i class="fa fa-dashboard text-dark text-lg opacity-10"></i>
                </div>
        ...
        <li class="nav-item">
            <a class="nav-link {{ Route::current()->getName() == "profile" ? "active" : "" }}" href="{{ route('profile') }}">
                <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fa fa-user text-dark text-lg opacity-10"></i>
                </div>
        ...
        <li class="nav-item">
            <a class="nav-link {{ Route::current()->getName() == "karyawan.leave" ? "active" : "" }}" href="{{ route('karyawan.leave') }}">
                <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fa fa-list text-dark text-lg opacity-10"></i>
                </div>
                <span class="nav-link-text ms-1">Manajemen Cuti</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ Route::current()->getName() == "logout" ? "active" : "" }}" href="{{ route('logout') }}">
                <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fa fa-sign-out text-dark text-lg opacity-10"></i>
                </div>
                <span class="nav-link-text ms-1">Logout</span>
            </a>
        </li>
        <div class="mx-4 my-2 mt-4 font-weight-bolder text-uppercase {{ auth()->user()->role_id == 2 ? "d-none" : "" }}">Manajemen Karyawan</div>
        <li class="nav-item {{ auth()->user()->role_id == 2 ? "d-none" : "" }}">
        ...
        <li class="nav-item {{ auth()->user()->role_id == 2 ? "d-none" : "" }}">
            <a class="nav-link {{ Route::current()->getName() == "karyawan.create" ? "active" : "" }}" href="{{ route('karyawan.create') }}">
                <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fa fa-plus-square text-dark text-lg opacity-10"></i>
                </div>
        ...
        <li class="nav-item {{ auth()->user()->role_id == 2 ? "d-none" : "" }}">
            <a class="nav-link {{ Route::current()->getName() == "material.create" ? "active" : "" }}" href="{{ route('material.create') }}">
                ...
                <span class="nav-link-text ms-1">Tambah Bahan</span>
            </a>
        </li>
        <div class="mx-4 my-2 mt-4 font-weight-bolder text-uppercase {{ auth()->user()->role_id == 2 ? "d-none" : "" }}">Manajemen Menu / Resep</div>
        <li class="nav-item {{ auth()->user()->role_id == 2 ? "d-none" : "" }}">
            <a class="nav-link {{ Route::current()->getName() == "menu.index" ? "active" : "" }}" href="{{ route('menu.index') }}">
                <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fa fa-sticky-note text-dark text-lg opacity-10"></i>
                </div>
        ...
        <li class="nav-item {{ auth()->user()->role_id == 2 ? "d-none" : "" }}">
            <a class="nav-link {{ Route::current()->getName() == "menu.create" ? "active" : "" }}" href="{{ route('menu.create') }}">
                ...
                <span class="nav-link-text ms-1">Tambah Resep</span>
            </a>
        </li>
    </ul>
</div>
